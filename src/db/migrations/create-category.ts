...
export class Migration1747493844289 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "account" ALTER COLUMN "accountType" TYPE "public"."account_accounttype_enum" USING "accountType"::"text"::"public"."account_accounttype_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."account_accounttype_enum_old"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."account_accounttype_enum_old" AS ENUM('SAVINGS', 'CURRENT', 'CASH', 'CREDIT')`,
    );
    await queryRunner.query(
      `ALTER TABLE "account" ALTER COLUMN "accountType" TYPE "public"."account_accounttype_enum_old" USING "accountType"::"text"::"public"."account_accounttype_enum_old"`,
    );
    await queryRunner.query(`DROP TYPE "public"."account_accounttype_enum"`);
    await queryRunner.query(
      `ALTER TYPE "public"."account_accounttype_enum_old" RENAME TO "account_accounttype_enum"`,
    );
